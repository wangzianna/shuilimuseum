...
<div class="result">
	<div class="container">
	  <div class="col-md-9 pull-right text-right">获得约 <?php echo $totalnums;?> 条结果 （用时<?php echo sprintf("%01.2f", $execute_time);?> 秒）</div>
...
<div class="container content-detail" style="background: #fff;padding-bottom: 50px;">
    	<div class="sr_main">
        	<div class="sr_head">
            	...
            	<div class="r" style="display: none;"><script type="text/javascript">document.write('<iframe src="<?php echo APP_PATH;?>index.php?m=member&c=index&a=mini&forward='+encodeURIComponent(location.href)+'&siteid=<?php echo get_siteid();?>" allowTransparency="true"  width="300" height="24" frameborder="0" scrolling="no"></iframe>')</script></div>
            </div>

            <div class="wrap sr_logo">
            	<!--<a href="index.php?m=search&siteid=<?php echo $siteid;?>" class="l">
            		<img src="<?php echo IMG_PATH;?>search/se_logo.png" width="230" height="158" />
            	</a>-->
                <div class="l">
                	...
                	<ul class="wrap">
						...
						<li class="wrap resullist">
							<div>
								...
								<h5 style="font-size: 16px;margin-bottom: 5px;color: #aa8146;"><a href="<?php echo $r['url'];?>" style="color:#aa8146;"><?php echo $r['title'];?></a><?php if($r['posids']) { ?>
									<img src="<?php echo IMG_PATH;?>icon/small_elite.gif"><?php } ?>
								</h5>
								<?php if($r['thumb']) { ?><a href="<?php echo $r['url'];?>">
									<img src="<?php echo $r['thumb'];?>" width="100" height="60" class="pull-left" style="margin-right: 10px;"></a>
									<?php } ?>
								<p style="text-align: left;"><?php echo str_cut(strip_tags($r[description]),200,'…');?></p>
						...
						<?php $n++;}unset($n); ?>
						<?php if(empty($data)) { ?>
						<p style="text-align:center; font-size:15px; margin-top: 50px;">没有找到和<font color="#FF0000;" style="text-decoration:underline; font-weight:bold; " ><?php echo $q;?></font>相关的文章，请减短关键词或换个词组！</p>
                        
						
						<?php } ?>
<nav class="pagination"><?php echo $pages;?></nav>						
