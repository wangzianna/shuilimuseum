...
<div id="header"></div>
<!--百度地图容器-->
<div class="map container content-detail">
   <div class="row">
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(120.319123,30.2649);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"中国水利博物馆",content:"浙江省杭州市萧山区水博大道1号",point:"120.319114|30.265103",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
    ];
    //创建marker
    function addMarker(){
